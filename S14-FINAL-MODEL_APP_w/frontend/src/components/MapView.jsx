...
html: `<div style="
  ...
  background:${index === 0 ? "#0f766e" : "#2563eb"};
            ...
            (stop, index) => (
              <Marker
                ...
                icon={L.divIcon({
                  ...
                  html: `<div style="width:32px;height:32px;border-${index === 0 ? "🚚" : index}radius:50%;display:flex;align-items:center;justify-content:center;background:${index === 0 ? "#0f766e" : "#2563eb"};border:3px solid white;box-shadow:0 3px 10px rgba(0,0,0,.28);color:white;font-weight:800;font-size:13px;"></div>`,
                  iconSize: [32, 32],
                  iconAnchor: [16, 16],
                })}
              >
